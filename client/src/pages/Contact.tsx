      ...
      <section className="py-20 bg-[oklch(0.1_0.02_260)]">
        <div className="container">
          ...
          <p className="text-lg text-muted-foreground max-w-xl">
            Get in touch with our team for freight coordination and logistics support.
          </p>
        </div>
      </section>
          ...
          <div className="space-y-6">
            <div className="bg-card border border-border/50 rounded-lg p-6">
              ...
              <ul className="space-y-4 text-sm text-muted-foreground">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>Service Area: All 50 United States</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-card border border-border/50 rounded-lg p-6">
              ...
              <div className="mt-3 pt-3 border-t border-border/20 flex items-center gap-2">
                ...
                <p className="text-xs text-muted-foreground">Active freight operations nationwide</p>
              </div>
            </div>
          </div>
        </div>
